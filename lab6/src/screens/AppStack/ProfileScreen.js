...
const ProfileScreen = () => {
    ...
    return (
        <Container>
            <DeleteButton onPress={() => navigation.replace("ConfirmDeleteProfile")}>
            ...
            <Content>
                ...
                <Field>Ім'я: <FieldValue>{getField(profile?.name)}</FieldValue></Field>
                <Field>Прізвище: <FieldValue>{getField(profile?.lastname)}</FieldValue></Field>
                <Field>Місто: <FieldValue>{getField(profile?.city)}</FieldValue></Field>
                <Field>Вік: <FieldValue>{getField(profile?.yearsOld)}</FieldValue></Field>
                <Field>Хоббі: <FieldValue>{getField(profile?.hobby)}</FieldValue></Field>
            </Content>
